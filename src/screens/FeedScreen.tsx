  ...
  return (
    ...
    <TouchableWithoutFeedback onPress={handleDoubleTap} onLongPress={handleLongPress}>
      ...
      {/* Comments section */}
         ...
         {/* Reply input */}
         {/* --- UNIFIED CAPSULE INPUT SECTION --- */}
         <View style={{ flexDirection: 'column', width: '100%', paddingHorizontal: 15, paddingBottom: 10 }}>
           
             {/* 1. First Layer: Your Existing Reaction Buttons Component/Row */}
               <View style={{ flexDirection: 'row', marginBottom: 12, alignItems: 'center' }}>
                   {/* Your app's existing reaction emojis go here */}
                     </View>

                       {/* 2. Second Layer: The Unified Input Capsule Box directly below them */}
                         <View style={styles.sketchInputContainer}>
                             <TextInput
                                   style={styles.sketchTextInput}
                                         placeholder="Write a reply..."
                                               placeholderTextColor="#888"
                                                     value={replyText} // Uses your existing replyText state variable
                                                           onChangeText={setReplyText} // Uses your existing state setter
                                                               />
                                                                   <TouchableOpacity 
                                                                         style={styles.sketchSendButton}
                                                                               onPress={handleSendReply} // Triggers your existing reply submission function
                                                                                   >
...
export default function FeedScreen() {
  ...
  // ── Watch time handler ────────────────────────────────────────────────────────
  const handleSendReply = () => {
    if (!replyText.trim() || !activeCommentPost) return;
                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                              <Text style={styles.backButtonAngle}>‹</Text>
                                                                                                                                                                                                                                                                                                                                                                                                                                                              ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                              <Text style={styles.modalTitle}>Comments</Text>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                          {/* Scrollable Comments Area */}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     {/* Scrollable Comments Area */}
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           <ScrollView style={styles.modalCommentsScroll}>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   {activeCommentPost?.comments && activeCommentPost.comments.length > 0 ? (
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             activeCommentPost.comments.map((comment: any, index: number) => {
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         // Check if comment is a direct string or an object
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     const isString = typeof comment === 'string';
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 const commentUser = isString ? "User" : (comment.username || comment.user || "User");
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             const commentContent = isString ? comment : (comment.text || comment.content || "");

                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         return (
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       <View key={index} style={styles.commentBubbleContainer}>
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                fontSize: 14,
                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                  inlineCommentsWrapper: {
                                                                                                                                                                                                                        marginTop: 15,
                                                                                                                                                                                                                            paddingHorizontal: 15,
                                                                                                                                                                                                                                paddingBottom: 10,
                                                                                                                                                                                                                                 backgroundColor: '#fff', // Gives it a solid background so post elements can't bleed through
                                                                                                                                                                                                                                     display: 'flex',      // Enforces standard flexbox document flow
                                                                                                                                                                                                                                         flexDirection: 'column', 
                                                                                                                                                                                                                                           },   
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            inlineCommentRow: {
                                                                                                                                                                                                                                                flexDirection: 'row',
                                                                                                                                                                                                                                                    alignItems: 'center',
                                                                                                                                                                                                                                                        marginBottom: 4,
                                                                                                                                                                                                                                                            backgroundColor: 'rgba(0, 0, 0, 0.06)', // Slightly darker so it is visible on mobile screens
                                                                                                                                                                                                                                                                padding: 6,
                                                                                                                                                                                                                                                                    borderRadius: 8,
                                                                                                                                                                                                                                                                      },
